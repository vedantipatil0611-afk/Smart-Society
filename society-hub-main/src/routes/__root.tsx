...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SocietyOS — Modern Society Management" },
      {
        name: "description",
        content:
          "SocietyOS is a premium platform to manage residents, visitors, maintenance, complaints, and events for housing societies.",
      },
      { name: "author", content: "SocietyOS" },
      { property: "og:title", content: "SocietyOS — Modern Society Management" },
      {
        property: "og:description",
        content: "Manage residents, visitors, maintenance and more in one elegant platform.",
      },
